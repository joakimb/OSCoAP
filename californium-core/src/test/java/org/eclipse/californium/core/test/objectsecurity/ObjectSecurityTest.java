...
public class ObjectSecurityTest {
    ...
    public void testIV(){
        ...
        try {
            ...
            assertArrayEquals(new byte[] {0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x46}, ctx.getSenderIV());
            ctx.increaseSenderSeq();
            assertArrayEquals(new byte[] {0x47, 0x47, 0x47, 0x47, 0x47, 0x47, 0x45}, ctx.getSenderIV());
            for (int i = 2; i < 256; i++) ctx.increaseSenderSeq();
            assertArrayEquals(new byte[] {0x47, 0x47, 0x47, 0x47, 0x47, 0x46, 0x47}, ctx.getSenderIV());
